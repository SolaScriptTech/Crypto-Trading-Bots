...
MIN_SAFE_DURATION = 2      # The "Guarantee": Must never be < 2 candles
MIN_FLIPS = 15             # Sample Size: Must have flipped at least 10 times to be valid
HISTORY_LIMIT = 320        # Lookback window (approx 320 candles)
